...
class Cube:
    def __init__(self, app):
        ...
        self.texture = self.get_texture(path='C:/Users/Admin/Desktop/Cold 2 Global/textures/img2.png')
        self.on_init()
    ...
    def get_shader_program(self, shader_name):
        with open(f'C:/Users/Admin/Desktop/Cold 2 Global/shaders/{shader_name}.vert') as file:
            vertex_shader = file.read()

        with open(f'C:/Users/Admin/Desktop/Cold 2 Global/shaders/{shader_name}.frag') as file:
